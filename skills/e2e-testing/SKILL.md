...
**一言で**: Playwright E2Eテストの実装パターン
**いつ読み込まれるか**: `/e2e` コマンド実行時、Playwrightのテスト作成・フレークテスト対策・CI/CD統合時にエージェントが参照する
**チームへの影響**: ClaudeがPage Object Modelパターンやネットワーク待機・アーティファクト管理を正しく実装するようになり、フレークテストの発生率が下がりCI/CDの信頼性が向上する。
